        ...
        <nav className="flex items-center justify-between flex-wrap bg-gray-500 p-6">
            <div className="flex items-center flex-shrink-0 text-white mr-6">
                ...
                <div className="flex flex-col items-start">
                    ...
                    <span className="font-regular text-sm tracking-tight">
                        {header?.siteTagLine}
                    </span>
                </div>
            </div>
            ...
            <div
                ...
                } overflow-hidden lg:h-auto w-full block flex-grow lg:flex lg:items-center lg:w-auto`}
            >
                {headerMenus?.length ? (
